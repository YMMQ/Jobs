...
ActiveRecord::Schema.define(version: 20161118190057) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "add_professions", force: :cascade do |t|
    t.integer  "addv_id"
    t.integer  "profession_id"
    t.integer  "qty"
    t.datetime "created_at",    null: false
    t.datetime "updated_at",    null: false
    t.index ["addv_id"], name: "index_add_professions_on_addv_id", using: :btree
    t.index ["profession_id"], name: "index_add_professions_on_profession_id", using: :btree
  end
  ...
  create_table "addvs", force: :cascade do |t|
    ...
    t.datetime "created_at",      null: false
    t.datetime "updated_at",      null: false
    t.index ["city_id"], name: "index_addvs_on_city_id", using: :btree
    t.index ["newspaper_id"], name: "index_addvs_on_newspaper_id", using: :btree
  ...
  create_table "degrees", force: :cascade do |t|
    t.integer  "t_degree_id"
    t.string   "name"
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["t_degree_id"], name: "index_degrees_on_t_degree_id", using: :btree
  end
  ...
  create_table "t_degrees", force: :cascade do |t|
    t.string   "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  add_foreign_key "add_professions", "addvs"
  add_foreign_key "add_professions", "professions"
  add_foreign_key "addvs", "cities"
  add_foreign_key "addvs", "newspapers"
  add_foreign_key "addvs", "organizations"
  add_foreign_key "cities", "provinces"
  add_foreign_key "degrees", "t_degrees"
