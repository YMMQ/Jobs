...
class UserInfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_info" do
    assert_difference('UserInfo.count') do
      post user_infos_url, params: { user_info: { dob: @user_info.dob, fname: @user_info.fname, gender: @user_info.gender, lname: @user_info.lname, mobile: @user_info.mobile, picture: @user_info.picture, user_id: @user_info.user_id } }
    end
  ...
  test "should update user_info" do
    patch user_info_url(@user_info), params: { user_info: { dob: @user_info.dob, fname: @user_info.fname, gender: @user_info.gender, lname: @user_info.lname, mobile: @user_info.mobile, picture: @user_info.picture, user_id: @user_info.user_id } }
